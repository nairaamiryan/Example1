...
const DocumentAttach = ({ onClose, onSave }) => {
    ...
    const handleSave = () => {
        if (!form.title || !form.date || !file) return;
    ...
    const disabled = !form.title || !form.date || !file;

    return (
        <div style={styles.overlay} onClick={onClose}>
            <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
                <div style={styles.header}>
                    <h2 style={styles.title}>📎 Փաստաթուղթ կցել</h2>
...
const styles = {
    ...
    fileArea: { border: "2px dashed #d1d5db", borderRadius: "8px", padding: "16px", textAlign: "center" },
    fileLabel: { cursor: "pointer", fontSize: "14px", color: "#2563eb", fontWeight: "500" },
